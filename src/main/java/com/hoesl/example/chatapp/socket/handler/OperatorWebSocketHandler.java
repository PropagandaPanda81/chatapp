...
@Component
public class OperatorWebSocketHandler extends DefaultWebSocketHandler {
	...
	public OperatorWebSocketHandler(WebSocketSessionManager sessionManager) {
		super(sessionManager);
	}

	@Override
	public void afterConnectionEstablished(WebSocketSession session) throws Exception {
		sessionManager.addSession(ChatConstants.OPERATOR, session);
	}
	...
	protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
		...
		String recipient = ChatConstants.CUSTOMER;
	...
	public void afterConnectionClosed(WebSocketSession session, CloseStatus status) throws Exception {
		sessionManager.removeSession(ChatConstants.OPERATOR);
	}
